/*
    ...
    The license for data in this file is unclear.
    The font `tama mini02` *seems* to be freely available
    on the internet, many sites list the data as public domain
    or freely usable for private and commercial purposes.

    Also the header was generated by a script available
    on the internet at:
...
namespace embedded_drivers {
	namespace font_tama_mini02 {
		...
		// tama_mini02_font.h
		// copied from https://jared.geek.nz/2014/jan/custom-fonts-for-microcontrollers
		// unknown license, probably public domain.
		uint8_t data[96][5] = {
		...
		uint8_t const * dataptr = &data[0][0];
		unsigned const width = sizeof(data[0]);
		unsigned const height = 8;
		unsigned const first_character = 0x20;
		unsigned const character_count = sizeof(data) / sizeof(data[0]);
